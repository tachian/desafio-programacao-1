...
RSpec.describe DocumentsController, type: :controller do
  ...
  let(:invalid_attributes) {
    FactoryBot.attributes_for(:invalid_document)
  }
  ...
  describe "POST documents/import" do
    it "upload file and persist content" do
      file = fixture_file_upload('example_input.tab')
      post :import, params: {file: file}

      documents = Document.order(:purchaser_name)
      expect(documents.count).to eq(4)
      expect(documents[0].purchaser_name).to eq('Amy Pond')
      expect(documents[3].purchaser_name).to eq('Snake Plissken')
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        FactoryBot.attributes_for(:updated_document)
      }
      ...
      it "updates the requested document" do
        ...
        document.reload
        expect(document.purchaser_name).to eq(new_attributes[:purchaser_name]) 
      end
